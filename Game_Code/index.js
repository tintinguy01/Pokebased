...
//Moving background for animation
...
function rectangularCollision({rectangel1, rectangel2}) {
    return(rectangel1.position.x + rectangel1.width >= rectangel2.position.x &&
